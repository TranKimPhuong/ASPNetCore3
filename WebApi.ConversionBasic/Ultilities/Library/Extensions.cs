...
namespace WebApi.ConversionBasic.Ultilities.Library
{
    ...
    {
        public static string Mid(this string sText, int iPos, int iLen = 0)
        {
        ...
        public static string TMid(this string text, int piPos, int piLen)
        {
            if (piPos < 0)
                return string.Empty;
        ...
        public static List<string> LoadListFields(this string psStringInput, string psDelimeter, string psQuote)
        {
    ...
    public static class IEnumerableExtensions
    {
        ...
        public static void RemoveRange<T>(this IList<T> iList, IEnumerable<T> itemsToRemove)
        {
   ...
   (this IEnumerable<TSource> source, Func<TSource, TKey> keySelector)
    ...
    public static class ByteArrayExtensions
    {
        ...
        /// <returns></returns>
        public static DataTable ReadDataFromExcel(this byte[] byteArr, int sheetIndex = 0)
        {
            if (sheetIndex < 0)
