...
{
    public static class ParseCityStateZip
    {
        ...
        public static bool TryParseCityStateZip(this string value, out string city, out string state, out string zip)
        {
        ...
        public static bool ValidateUSorCanadianZipCode(string zipCode)
        {
