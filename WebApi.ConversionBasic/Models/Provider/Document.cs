...
namespace WebApi.ConversionBasic.Models.Provider
{
    public abstract class Document
    {
        ...
        public List<DocumentDetailLine> DetailLines { get; }
        public abstract DocumentDetailLine CreateNewDocumentDetailLine();


        public virtual void AssignHeader(Map map, Page page, Dictionary<string, List<string>> addressPreFixs)
        {
        ...
        public virtual void AssignDetailLineFromRemitFile(Map map, string dataLine, string columnHeaderName = "")
        {
            var mapRemittance = map.MapRemittance;
        ...
        public int GetPositionOfField(Map map, string columnHeaderName, string sFieldName)
        {
