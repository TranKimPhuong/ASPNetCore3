...
using System.Linq;
using System.Text;
using WebApi.ConversionBasic.Models;
...
{
    public abstract class PsTool
    {
        public ConversionRequest CurrentConversionRequest { get; private set; } = null;
        public void SetCurrentConversionRequest(ConversionRequest request)
        {
            CurrentConversionRequest = request;
        }

        public Dictionary<string, List<string>> AddressPreFixs;

        public Map Map;
        public List<Page> Pages;
        public List<Page> PageRemittances;

        public IList<Document> Documents = new List<Document>();
        public List<string> ListErrors { get; } = new List<string>();
        ...
        public StringBuilder ProcessDataFile(byte[] primaryFile, byte[] remittanceFileContent = null)
        {
            Initialize();
        ...
        public StringBuilder ProcessMultiDataFile(IEnumerable<FormFile> primaryFiles, IEnumerable<FormFile> remittanceFiles)
        {
            Initialize();
        ...
        public virtual List<Page> FillData(byte[] inputFile)
        {
        ...
        public List<Page> FillRemittanceData(byte[] remittanceFileContent)
        {
        ...
        public virtual void ProcessBeforeConvertDocumentsToStandardFile()
        {
        ...
        public abstract StringBuilder BuildStandardFileHeader();
        public abstract StringBuilder ConvertDocumentsToStandardFile();

        #region methods

        public virtual void SetKeyAndOverflow(Page page)
        {
            // check over
        ...
        public virtual void SetKeyAndOverflowForRemittancePage(Page page)
        {
            var mapRemittance = this.Map.MapRemittance;
            // check over
        ...
        public static bool CheckCondition(List<Condition> conditions, string data)
        {
        ...
        public bool ValidateFileFormatBySpecificPos(Page page, List<Condition> conditions,
